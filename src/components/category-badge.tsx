...
const getCategoryColor = (category: string) => {
  ...
  if (normalized.includes('tool') || normalized.includes('agent')) return "bg-purple-100 text-purple-800 dark:bg-purple-900/50 dark:text-purple-300 border-purple-200 dark:border-purple-800";
