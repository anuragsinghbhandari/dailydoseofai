...
import { z } from "zod";
import { createUpdate, type NewUpdate } from "@/server/updates";
import {
  Form,
  FormControl,
  FormField,
...
export const Route = createFileRoute("/admin/create-update")({
...
function CreateUpdatePage() {
  ...
  const mutation = useMutation({
    mutationFn: (values: FormValues) =>
      (createUpdate as any)({ data: values as NewUpdate }),
    onSuccess: async () => {
      ...
      toast({
        title: "Success",
        description: "The update was created successfully.",
      });
    ...
    onError: () => {
      toast({
        title: "Error",
        description: "Failed to create the update. Please try again.",
        variant: "destructive",
      });
    }
  });
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Draft a new AI update. You can publish it immediately or keep it as a draft.
          </p>
        </div>
      </div>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="OpenAI releases GPT-X" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            placeholder="openai-releases-gpt-x"
                            {...field}
                          />
                        </FormControl>
                        <FormDescription>
